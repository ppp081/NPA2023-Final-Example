...
accessToken = "Bearer ZGU2ZGQyZDctN2RhYS00YWI5LTk5ZjYtZDhiYWNmMzQ1YWM1OGMzZmM3MDQtNjJj_P0A1_bc884c7a-820b-497b-8b60-00b4d15ea95d" 
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    if message.find("/pp08") == 0:
        location = message[len("/pp08 "):].strip()
...
# 5. Prepare openweather Geocoding APIGetParameters..
        ...
        openweatherGeoAPIGetParameters = {
                    "q": location,
                    "limit": 1,
                    "appid": "07bab13bda1b3d9a97b000098021919f",
                }
#######################################################################################       
